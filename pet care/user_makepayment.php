...
if (isset($_POST['payment'])) {
   ...
   $q="insert into payment values(null,'$bid','$aid',curdate(),'doctor')";
   insert($q);
   alert('successfully');
 return redirect('user_viewdoctor.php');
}
...
<center>
	...
	<form method="post">
		<table class="table" style="width: 500px">
			...
			<tr>
				<th>amount</th>
				<td><input type="text" required=""  class="form-control" value="<?php echo $aid;?>" name=""></td>
			</tr>
			<tr>
